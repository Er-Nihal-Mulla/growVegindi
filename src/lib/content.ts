...
export const content: Record<Language, ContentStructure> = {
  ...
  mr: {
    hero: {
      ...
      subtitle: 'ग्रो वेजइंडीमध्ये सामील व्हा आणि थेट आमच्याशी संपर्क साधा. मध्यस्थांना वगळा, आपल्या उत्पादनांचे दर ठरवा आणि शेतीतून मिळणारे उत्पन्न वाढवा.',
    },
    features: [
        { title: "थेट खरेदीदारांना विका", description: "मध्यस्थांना वगळा आणि थेट ग्रो वेजइंडीला विक्री करा. ग्रो वेजइंडी आपल्या ताज्या उत्पादनांचे ग्राहकांपर्यंत वितरण करते." },
