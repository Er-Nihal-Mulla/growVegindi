        ...
        <section id="cta" className="py-16 md:py-24 bg-primary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/sign-up" passHref><Button size="lg" variant="secondary">{content.buttons.registerFarmer}</Button></Link>
              <Link href="/products" passHref><Button size="lg" variant="secondary">{content.buttons.shopNow}</Button></Link>
              <Link href="/sign-up?role=seller" passHref><Button size="lg" variant="outline" className="bg-transparent border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary">{content.buttons.startSelling}</Button></Link>
            </div>
          </div>
        </section>
      </main>
